...
impl ServerMessage {
    ...
    pub fn update_positions(unix_time: u64, packages: Vec<PositionPackage>) -> Self {
        Self {
            reliable: 0,
            message: ServerMessageInner::UpdatePositions{unix_time, packages},
        }
    }
...
fn update_unix_time_system(
    mut unix_time: ResMut<UnixTime>,
) {
