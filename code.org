...
** server.rs components and resources
#+begin_src rust :tangle src/bin/server.rs
...
** client.rs components and resources
#+begin_src rust :tangle src/bin/client.rs
...
** clients.rs setup spawn glb house
#+begin_src rust :tangle src/bin/client.rs
fn setup(
    outgoing_sender: Res<OutgoingSender>,
    mut commands: Commands,
...
*** clients.rs spawn update entities
#+begin_src rust :tangle src/bin/client.rs
...
*** clients.rs update positions velocities
#+begin_src rust :tangle src/bin/client.rs
                        }
                    },
